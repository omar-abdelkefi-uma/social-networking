...
public class Login_Workflow extends BaseTest {

    // TODO: Data provider
    String dtUsername = "test@gmail.com";
    String dtPassword = "test";
    ...
    public void TC001_AddToCart_Checkout() {
        ...
        new LoginPage(driver).loginWithGithub(dtUsername, dtPassword);  
