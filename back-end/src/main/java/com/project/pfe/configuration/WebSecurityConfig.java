...
import com.project.pfe.security.jwt.TokenAuthenticationFilter;
import com.project.pfe.security.oauth2.CustomOAuth2UserService;
import com.project.pfe.security.oauth2.CustomOidcUserService;
import com.project.pfe.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import com.project.pfe.security.oauth2.OAuth2AccessTokenResponseConverterWithDefaults;
import com.project.pfe.security.oauth2.OAuth2AuthenticationFailureHandler;
import com.project.pfe.security.oauth2.OAuth2AuthenticationSuccessHandler;
...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.csrf().disable().cors().and().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
				...
				.requestMatchers("/", "/error", "/api/all", "/api/auth/**", "/new-password", "/oauth2/**",
						"/forgot-password", "api/auth/signin")
