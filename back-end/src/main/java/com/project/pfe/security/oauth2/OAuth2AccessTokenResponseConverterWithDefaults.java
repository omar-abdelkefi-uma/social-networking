...
public class OAuth2AccessTokenResponseConverterWithDefaults implements Converter<Map<String, Object>, OAuth2AccessTokenResponse> {
	...
	public OAuth2AccessTokenResponse convert(Map<String, Object> tokenResponseParameters) {
		...
		return OAuth2AccessTokenResponse.withToken(String.valueOf(accessToken)).tokenType(accessTokenType).expiresIn(expiresIn).scopes(scopes).additionalParameters(additionalParameters).build();
	}
